export class RepositoryConsts {
  ...
  public static POLKADOT_BALANCE_ACCOUNTS_LATEST_SYNC_BLOCK_REPOSITORY: string =
    'POLKADOT_BALANCE_ACCOUNTS_LATEST_SYNC_BLOCK_REPOSITORY';
  ...
  //Moonriver Balance
  public static DATABASE_CONNECTION_MOONRIVER_BALANCE: string =
    'DATABASE_CONNECTION_MOONRIVER_BALANCE';

  public static MOONRIVER_BALANCE_ACCOUNT_REPOSITORY: string =
    'MOONRIVER_BALANCE_ACCOUNT_REPOSITORY';
  public static MOONRIVER_BALANCE_ACCOUNT_SNAPSHOTS_REPOSITORY: string =
    'MOONRIVER_BALANCE_ACCOUNT_SNAPSHOTS_REPOSITORY';
  public static MOONRIVER_BALANCE_BALANCE_SETS_REPOSITORY: string =
    'MOONRIVER_BALANCE_BALANCE_SETS_REPOSITORY';
  public static MOONRIVER_BALANCE_DEPOSITS_REPOSITORY: string =
    'MOONRIVER_BALANCE_DEPOSITS_REPOSITORY';
  public static MOONRIVER_BALANCE_ENDOWEDS_REPOSITORY: string =
    'MOONRIVER_BALANCE_ENDOWEDS_REPOSITORY';
  public static MOONRIVER_BALANCE_RESERVEDS_REPOSITORY: string =
    'MOONRIVER_BALANCE_RESERVEDS_REPOSITORY';
  public static MOONRIVER_BALANCE_RESERVREPATRIATEDS_REPOSITORY: string =
    'MOONRIVER_BALANCE_RESERVREPATRIATEDS_REPOSITORY';
  public static MOONRIVER_BALANCE_SLASH_REPOSITORY: string =
    'MOONRIVER_BALANCE_SLASH_REPOSITORY';
  public static MOONRIVER_BALANCE_TRANSFERS_REPOSITORY: string =
    'MOONRIVER_BALANCE_TRANSFERS_REPOSITORY';
  public static MOONRIVER_BALANCE_UNRESERVEDS_REPOSITORY: string =
    'MOONRIVER_BALANCE_UNRESERVEDS_REPOSITORY';
  public static MOONRIVER_BALANCE_WITHDRAWS_REPOSITORY: string =
    'MOONRIVER_BALANCE_WITHDRAWS_REPOSITORY';
  public static MOONRIVER_BALANCE_ACCOUNTS_LATEST_SYNC_BLOCK_REPOSITORY: string =
    'MOONRIVER_BALANCE_ACCOUNTS_LATEST_SYNC_BLOCK_REPOSITORY';

  //Kusama Balance
  public static DATABASE_CONNECTION_KUSAMA_BALANCE: string =
  'DATABASE_CONNECTION_KUSAMA_BALANCE';
  public static KUSAMA_BALANCE_ACCOUNT_REPOSITORY: string =
    'KUSAMA_BALANCE_ACCOUNT_REPOSITORY';
  public static KUSAMA_BALANCE_ACCOUNT_SNAPSHOTS_REPOSITORY: string =
    'KUSAMA_BALANCE_ACCOUNT_SNAPSHOTS_REPOSITORY';
  public static KUSAMA_BALANCE_BALANCE_SETS_REPOSITORY: string =
    'KUSAMA_BALANCE_BALANCE_SETS_REPOSITORY';
  public static KUSAMA_BALANCE_DEPOSITS_REPOSITORY: string =
    'KUSAMA_BALANCE_DEPOSITS_REPOSITORY';
  public static KUSAMA_BALANCE_ENDOWEDS_REPOSITORY: string =
    'KUSAMA_BALANCE_ENDOWEDS_REPOSITORY';
  public static KUSAMA_BALANCE_RESERVEDS_REPOSITORY: string =
    'KUSAMA_BALANCE_RESERVEDS_REPOSITORY';
  public static KUSAMA_BALANCE_RESERVREPATRIATEDS_REPOSITORY: string =
    'KUSAMA_BALANCE_RESERVREPATRIATEDS_REPOSITORY';
  public static KUSAMA_BALANCE_SLASH_REPOSITORY: string =
    'KUSAMA_BALANCE_SLASH_REPOSITORY';
  public static KUSAMA_BALANCE_TRANSFERS_REPOSITORY: string =
    'KUSAMA_BALANCE_TRANSFERS_REPOSITORY';
  public static KUSAMA_BALANCE_UNRESERVEDS_REPOSITORY: string =
    'KUSAMA_BALANCE_UNRESERVEDS_REPOSITORY';
  public static KUSAMA_BALANCE_WITHDRAWS_REPOSITORY: string =
    'KUSAMA_BALANCE_WITHDRAWS_REPOSITORY';
  // public static DATABASE_CONNECTION_KUSAMA_IDENTITY_SERVICE: string =
  //   'DATABASE_CONNECTION_KUSAMA_IDENTITY_SERVICE';
  public static KUSAMA_BALANCE_ACCOUNTS_LATEST_SYNC_BLOCK_REPOSITORY: string =
    'KUSAMA_BALANCE_ACCOUNTS_LATEST_SYNC_BLOCK_REPOSITORY';
}
